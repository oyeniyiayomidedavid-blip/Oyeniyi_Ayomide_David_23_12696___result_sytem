...
// Fetch all users
try {
    $stmt = $pdo->query("SELECT id, full_name, username, role FROM users ORDER BY id DESC");
...
<div class="content">
    <h2>Users</h2>
    <p>Below is a list of all registered users. You can view, edit, or delete a user record.</p>
                ...
                <?php if(count($users) > 0): ?>
                    <?php foreach($users as $user): ?>
                        <tr>
                            ...
                            <td>
                                <a href="edit_user.php?id=<?= $user['id'] ?>" class="btn btn-warning btn-sm btn-action"><i class="fa fa-edit"></i> Edit</a>
                                <a href="delete_user.php?id=<?= $user['id'] ?>" class="btn btn-danger btn-sm btn-action"><i class="fa fa-trash"></i> Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
