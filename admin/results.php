...
// Fetch unique results (one per student/course)
try {
    $stmt = $pdo->query("
        SELECT r.id, s.full_name, s.matric_no, c.course_code, c.course_title, c.unit_load, r.score, r.grade
        FROM results r
...
<div class="sidebar">
    ...
    <a href="results.php" class="active"><i class="fa fa-graduation-cap"></i> Results</a>
...
<div class="content">
    <h2>Results</h2>
    <p>Below is a list of all student results (unique per student/course combination).</p>
                ...
                <?php if(count($results) > 0): ?>
                    <?php foreach($results as $res): ?>
                        <tr>
                            ...
                            <td><?= htmlspecialchars($res['unit_load']) ?></td>
